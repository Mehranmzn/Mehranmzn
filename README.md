...
- ✅ **Data Engineering:** dbt, SQL, PySpark, Databricks, Pollars, DuckDB
- ✅ **MLOps:** MLflow, Prefect,  Docker, Airflow  
- ✅ **APIs:** Flask, FastAPI
- ✅ **Apps:** Streamlit, Gradio 
- ✅ **Cloud Platforms:** Azure (AZ-900), Azure DevOps, Databricks, AWS
- ✅ **Version Control:** Git, Github

📜 Certifications: AWS Machine Learning Associate | Azure-900 Certified
🎓 Education: PhD Candidate in Machine Learning & Data Science (Utrecht University)

&nbsp;

📬 Let’s Connect – Always eager to explore new opportunities, share insights, and collaborate with like-minded professionals in the field of AI and Data Science.
&nbsp;

<h1>📄 Projects Portfolio</h1>

💰 You can explore my end-to-end projects in these repositories. If you find them helpful, don't forget to drop a ⭐! 😎
